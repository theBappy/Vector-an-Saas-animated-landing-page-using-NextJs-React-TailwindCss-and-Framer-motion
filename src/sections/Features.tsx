        ...
        <section className="py-24" id="features">
            <div className="container">
                ...
                <h2 className="max-w-2xl mx-auto text-6xl font-medium text-center mt-6">
                    Where power meets{" "}
                    <span className="text-[#8ECAE6]">simplicity</span>
                </h2>
                <div className="lg:grid-cols-3 mt-12 grid grid-cols-1 md:grid-cols-4 gap-8">
                    <FeatureCard
                    ...
                    <FeatureCard
                        className="md:col-span-2 md:col-start-2 lg:col-start-auto lg:col-span-1 group"
                        title="Keyboard Quick Actions"
                        description="Powerful way to help you create designs more efficiently"
                    >
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        ...
                        >
                            <span className="bg-[#8ECAE6] text-neutral-950 size-5 rounded-full inline-flex items-center justify-center text-xl group-hover:rotate-45 transition duration-500">
                                &#10038;
                            </span>
