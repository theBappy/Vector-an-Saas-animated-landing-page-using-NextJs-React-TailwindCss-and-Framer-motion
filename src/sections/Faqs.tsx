...
const faqs = [
    ...
    },
    {
        ...
        answer: "Yes! Layers includes a robust offline model. Changes sync automatically when you're back online, so you can keep working anywhere.",
    },
    {
        ...
        <section className="py-24" id="faqs">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium text-center mt-6 max-w-xl mx-auto">
                    Questions? We&apos;ve got{" "}
                    <span className="text-[#8ECAE6]">answer</span>
                </h2>
                        ...
                        >
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    className={twMerge(
                                        "feather feather-plus text-[#8ECAE6] flex-shrink-0 transition duration-300",
